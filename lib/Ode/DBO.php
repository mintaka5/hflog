...
class DBO extends \PDO
{
     ...
     * @return void
     */
    public function __construct($hostspec, $dbname, $user, $passwd, $pdoOptions = array())
    {
        ...
        try {
            parent::__construct("mysql:host=" . $this->getHost() . ";dbname=" . $this->getName(), $this->getUsername(), $this->getPassword(), $pdoOptions);
